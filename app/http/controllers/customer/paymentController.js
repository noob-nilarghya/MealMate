...
exports.createOrder= async(req, res) => {
    ...
    if(orderMethod === 'online'){
        try{
            ...
            // ----  Checkout page mein jane ki taiyaari ----
            ...
            const newOnlinePayment = await PaymentDetail.create({
                ...
                // Now we are left with 'paymentID' (will be updated during payment), 'signature' (will be updated during payment-conformation)
            });

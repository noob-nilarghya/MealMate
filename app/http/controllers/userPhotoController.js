...
exports.uploadPhoto= upload.single('photo'); // 'photo' is name of filed where uploaded file can be accessed from form
...
exports.userPhotoProcessing = async (req, res, next) => {
    ...
    req.file.filename = `user-${req.user._id}-${Date.now()}.jpeg`; // to use it in 'authController->updateInfo'
